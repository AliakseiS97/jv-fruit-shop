...
**Hint: Think about creating some service.basesyntax.model.FruitTransaction model to store info from file line for more convenient data processing 
(this is only a recommendation, you can use other classes/approaches to solve this task at your discretion):**
```java
public class service.basesyntax.model.FruitTransaction {
...
public class Main {
   public static void main(String[] arg) {
      ...
      // 5.Generate report based on the current service.basesyntax.model.Storage state
