...
**Hint: Think about creating some service.basesyntax.db.FruitTransaction model to store info from file line for more convenient data processing 
(this is only a recommendation, you can use other classes/approaches to solve this task at your discretion):**
```java
public class service.basesyntax.db.FruitTransaction {
